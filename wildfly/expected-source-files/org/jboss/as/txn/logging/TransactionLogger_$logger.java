 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-07-31T11:54:08+0200")
public class TransactionLogger_$logger extends DelegatingBasicLogger implements TransactionLogger, BasicLogger, Serializable {
    ...
    @Override
    public final IllegalStateException noActiveTransactionToRegisterSynchronization(final Synchronization sync) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), noActiveTransactionToRegisterSynchronization$str(), sync));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException jmxError(final String message) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), jmxError$str(), message));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException transactionDiscoveryError(final Exception e) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), transactionDiscoveryError$str()), e);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException unableToDetermineInboundTransactionContext(final Exception e) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), unableToDetermineInboundTransactionContext$str()), e);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException unableToSuspendInboundTransactionContext(final Exception e) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), unableToSuspendInboundTransactionContext$str()), e);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException cannotRegister(final Exception e) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), cannotRegister$str()), e);
        _copyStackTraceMinusOne(result);
        return result;
    }
}
