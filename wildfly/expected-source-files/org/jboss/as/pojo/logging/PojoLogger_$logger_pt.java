...
public class PojoLogger_$logger_pt extends PojoLogger_$logger implements PojoLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public PojoLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
