 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-07-09T10:27:23+0200")
public class PatchLogger_$logger extends DelegatingBasicLogger implements PatchLogger, BasicLogger, Serializable {
    ...
    @Override
    public final ContentConflictsException conflictsDetected(final Collection<ContentItem> conflicts) {
    ...
    @Override
    public final IOException entryOutsideOfPatchDirectory(final String path) {
        final IOException result = new IOException(String.format(getLoggingLocale(), entryOutsideOfPatchDirectory$str(), path));
        _copyStackTraceMinusOne(result);
        return result;
    }
}
