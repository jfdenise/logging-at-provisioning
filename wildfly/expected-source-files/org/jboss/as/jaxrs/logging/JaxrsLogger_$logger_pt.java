...
public class JaxrsLogger_$logger_pt extends JaxrsLogger_$logger implements JaxrsLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public JaxrsLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
