...
public class EeLogger_$logger_pt extends EeLogger_$logger implements EeLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public EeLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
