...
public class EeLogger_$logger_zh extends EeLogger_$logger implements EeLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public EeLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
