 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-07-09T10:27:20+0200")
public class JmxLogger_$logger extends DelegatingBasicLogger implements JmxLogger, BasicLogger, Serializable {
    ...
    @Override
    public final IllegalArgumentException invalidKey(final List<?> keys, final Entry<?, Object> entry) {
    ...
    @Override
    public final Error invalidObjectName(final String domain, final Hashtable<String, String> table, final String message) {
    ...
    @Override
    public final IllegalArgumentException expressionCannotBeConvertedIntoTargeteType(final OpenType<?> type) {
    ...
    @Override
    public final IllegalArgumentException badDomainInCalculatedObjectNameException(final ObjectName name) {
        final IllegalArgumentException result = new IllegalArgumentException(String.format(getLoggingLocale(), badDomainInCalculatedObjectNameException$str(), name));
        _copyStackTraceMinusOne(result);
        return result;
    }
    @Override
