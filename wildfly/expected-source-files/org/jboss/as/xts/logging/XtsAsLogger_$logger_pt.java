...
public class XtsAsLogger_$logger_pt extends XtsAsLogger_$logger implements XtsAsLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public XtsAsLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
