...
public class JdrLogger_$logger_pt extends JdrLogger_$logger implements JdrLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public JdrLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
