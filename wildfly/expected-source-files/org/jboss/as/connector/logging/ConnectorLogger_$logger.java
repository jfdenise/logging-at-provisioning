 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-07-31T11:56:48+0200")
public class ConnectorLogger_$logger extends DelegatingBasicLogger implements ConnectorLogger, BasicLogger, Serializable {
    ...
    @Override
    public final IllegalStateException invalidConnection(final Exception e) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), invalidConnection$str()), e);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final String failedToLoadModuleRA(final String moduleName, final String cause) {
        return String.format(getLoggingLocale(), failedToLoadModuleRA$str(), moduleName, cause);
    }
    ...
    @Override
    public final String rejectAttributesMustBeTrue(final Set<String> key) {
    ...
    @Override
    public final StartException cannotStartDSNoConnectionFactory(final String dataSourceJNDIName) {
        final StartException result = new StartException(String.format(getLoggingLocale(), cannotStartDSNoConnectionFactory$str(), dataSourceJNDIName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final StartException cannotStartDSTooManyConnectionFactories(final String dataSourceJNDIName, final int factoriesCount) {
        final StartException result = new StartException(String.format(getLoggingLocale(), cannotStartDSTooManyConnectionFactories$str(), dataSourceJNDIName, factoriesCount));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException threadPoolNameMustMatchWorkManagerName(final String threadPoolName, final String threadPoolType, final String workManagerName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), threadPoolNameMustMatchWorkManagerName$str(), threadPoolName, threadPoolType, workManagerName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException legacySecurityNotAvailable(final String connectionDef, final String ra) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), legacySecurityNotAvailable2$str(), connectionDef, ra));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException legacySecurityNotAvailable(final String datasourceName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), legacySecurityNotAvailable1$str(), datasourceName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final DeploymentUnitProcessingException legacySecurityNotAvailableForDsXml(final String datasourceName) {
        final DeploymentUnitProcessingException result = new DeploymentUnitProcessingException(String.format(getLoggingLocale(), legacySecurityNotAvailableForDsXml$str(), datasourceName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final DeploymentUnitProcessingException legacySecurityNotAvailableForRa(final String deploymentName) {
        final DeploymentUnitProcessingException result = new DeploymentUnitProcessingException(String.format(getLoggingLocale(), legacySecurityNotAvailableForRa$str(), deploymentName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalStateException legacySecurityNotAvailableForConnectionFactory(final String jndiName) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), legacySecurityNotAvailableForConnectionFactory$str(), jndiName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException wrongModuleName(final ModuleLoadException exception, final String moduleName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), wrongModuleName$str(), moduleName), exception);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException reportDirectoryDoesNotExist(final String reportDirectory) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), reportDirectoryDoesNotExist$str(), reportDirectory));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException legacySecurityAttributeNotSupported(final String attribute) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), legacySecurityAttributeNotSupported$str(), attribute));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException jdbcDriverNotInstalled(final String jdbcDriver) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), jdbcDriverNotInstalled$str(), jdbcDriver));
        _copyStackTraceMinusOne(result);
        return result;
    }
}
