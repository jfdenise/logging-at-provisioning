...
public class ConnectorLogger_$logger_zh extends ConnectorLogger_$logger implements ConnectorLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public ConnectorLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
