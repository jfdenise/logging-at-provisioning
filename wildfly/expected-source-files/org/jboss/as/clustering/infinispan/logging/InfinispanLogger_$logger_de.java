...
public class InfinispanLogger_$logger_de extends InfinispanLogger_$logger implements InfinispanLogger, BasicLogger, Serializable {
    ...
    protected String remoteCacheMustBeDefined$str() {
        return "WFLYCLINF0031: Die angegebene HotRod-Protokollversion %1$s unterstützt nicht die automatische Erstellung von Caches. Der Cache mit dem Namen \"%2$s\" muss bereits auf dem Infinispan-Server erstellt worden sein!";
    }
    @Override
