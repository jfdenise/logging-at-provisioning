...
public class JGroupsLogger_$logger_pt extends JGroupsLogger_$logger implements JGroupsLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public JGroupsLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
