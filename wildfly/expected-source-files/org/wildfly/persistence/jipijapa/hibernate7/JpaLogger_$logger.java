 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-07-22T10:38:22+0200")
public class JpaLogger_$logger extends DelegatingBasicLogger implements JpaLogger, BasicLogger, Serializable {
    ...
    protected String secondLevelCacheIsEnabled$str() {
        return "JIPIORMV7020260: Second level cache enabled for %s";
    }
    protected String HibernateORMDidNotRegisterLifeCycleListener$str() {
        return "JIPIORMV7020261: Hibernate ORM did not register LifeCycleListener";
    }
    @Override
    ...
    protected String ignoredCacheRegionSetting$str() {
        return "JIPIORMV7020262: Application custom cache region setting is ignored %s=%s";
    }
    protected String failOnIncompatibleSetting$str() {
        return "JIPIORMV7020263: hibernate.id.new_generator_mappings set to false is not supported, remove the setting or set to true.  Refer to Hibernate ORM migration documentation for how to update the next id state in the application database.";
    }
    @Override
    ...
    protected String unableOpenInputStream$str() {
        return "JIPIORMV7020264: Unable to open VirtualFile-based InputStream";
    }
    @Override
