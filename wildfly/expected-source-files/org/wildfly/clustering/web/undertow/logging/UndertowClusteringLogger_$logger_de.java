...
public class UndertowClusteringLogger_$logger_de extends UndertowClusteringLogger_$logger implements UndertowClusteringLogger, BasicLogger, Serializable {
    ...
    protected String sessionAlreadyExists$str() {
        return "WFLYCLWEBUT0002: Session %1$s existiert bereits";
    }
    @Override
    ...
    protected String batchIsAlreadyClosed$str() {
        return "WFLYCLWEBUT0009: Invalidierungsversuch für Session %1$s nach Commit der Antwort (z. B. nach HttpServletResponse.sendRedirect oder sendError)";
    }
}
