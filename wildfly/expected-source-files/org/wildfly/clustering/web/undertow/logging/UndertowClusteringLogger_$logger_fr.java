...
public class UndertowClusteringLogger_$logger_fr extends UndertowClusteringLogger_$logger implements UndertowClusteringLogger, BasicLogger, Serializable {
    ...
    protected String sessionAlreadyExists$str() {
        return "WFLYCLWEBUT0002: La session %1$s existe déjà";
    }
    @Override
    ...
    protected String batchIsAlreadyClosed$str() {
        return "WFLYCLWEBUT0009: Tentative d'invalidation de la session %1$s après que la réponse a été commise (par exemple après HttpServletResponse.sendRedirect ou sendError)";
    }
}
