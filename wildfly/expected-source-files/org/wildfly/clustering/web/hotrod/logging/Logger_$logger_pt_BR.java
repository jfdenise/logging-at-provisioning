...
public class Logger_$logger_pt_BR extends Logger_$logger_pt implements Logger, BasicLogger, Serializable {
    ...
    protected String failedToExpireSession$str() {
        return "WFLYCLWEBHR0001: Não foi possível terminar a sessão %1$s";
    }
    @Override
    protected String failedToActivateSession$str() {
        return "WFLYCLWEBHR0007: Falha ao ativar atributos da sessão %1$s";
    }
    @Override
    protected String failedToActivateSessionAttribute$str() {
        return "WFLYCLWEBHR0008: Falha ao ativar atributo %2$s da sessão %1$s";
    }
    @Override
    protected String failedToReadSessionAttribute$str() {
        return "WFLYCLWEBHR0009: Falha ao ler atributo %2$s da sessão %1$s";
    }
    @Override
    protected String failedToActivateAuthentication$str() {
        return "WFLYCLWEBHR0010: Falha ao ativar autenticação para logon único %1$s";
    }
    @Override
    protected String missingSessionAttributeCacheEntry$str() {
        return "WFLYCLWEBHR0011: A sessão %1$s não possui entrada de cache para atributo %2$s";
    }
}
