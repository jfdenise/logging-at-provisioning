...
public class BootableJarLogger_$logger_zh extends BootableJarLogger_$logger implements BootableJarLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public BootableJarLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
