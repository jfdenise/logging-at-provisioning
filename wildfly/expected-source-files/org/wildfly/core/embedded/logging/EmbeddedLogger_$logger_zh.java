...
public class EmbeddedLogger_$logger_zh extends EmbeddedLogger_$logger implements EmbeddedLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public EmbeddedLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
