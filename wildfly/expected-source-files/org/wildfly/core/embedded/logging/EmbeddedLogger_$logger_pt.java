...
public class EmbeddedLogger_$logger_pt extends EmbeddedLogger_$logger implements EmbeddedLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public EmbeddedLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
