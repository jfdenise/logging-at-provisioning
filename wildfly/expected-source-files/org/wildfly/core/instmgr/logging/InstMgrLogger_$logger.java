 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-07-09T10:27:22+0200")
public class InstMgrLogger_$logger extends DelegatingBasicLogger implements InstMgrLogger, BasicLogger, Serializable {
    ...
    @Override
    public final RuntimeException unexpectedArtifactChange(final String artifact) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), unexpectedArtifactChange$str(), artifact));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException unexpectedConfigurationChange(final String channel) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), unexpectedConfigurationChange$str(), channel));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException noChannelRepositoriesDefined(final String channelName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), noChannelRepositoriesDefined$str(), channelName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException noChannelRepositoryURLDefined(final String channelName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), noChannelRepositoryURLDefined$str(), channelName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException invalidChannelRepositoryURL(final String repoUrl, final String channelName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), invalidChannelRepositoryURL$str(), repoUrl, channelName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException noChannelRepositoryIDDefined(final String channelName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), noChannelRepositoryIDDefined$str(), channelName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException invalidChannelManifestGAV(final String gav, final String channelName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), invalidChannelManifestGAV$str(), gav, channelName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException invalidChannelManifestURL(final String url, final String channelName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), invalidChannelManifestURL$str(), url, channelName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException invalidRepositoryURL(final String repoUrl) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), invalidRepositoryURL$str(), repoUrl));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException channelNameNotFound(final String channelName) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), channelNameNotFound$str(), channelName));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException invalidManifestGAOnly(final String ga) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), invalidManifestGAOnly$str(), ga));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException invalidManifestGAV(final String gav) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), invalidManifestGAV$str(), gav));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final OperationFailedException noCustomPatchFound(final String manifestGA) {
        final OperationFailedException result = new OperationFailedException(String.format(getLoggingLocale(), noCustomPatchFound$str(), manifestGA));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final void provisioningChannels(final String channels) {
        super.log.logf(FQCN, INFO, null, provisioningChannels$str(), channels);
    }
    ...
    @Override
    public final void failedToCreateInstallationManager(final Path homeDir, final Exception failure) {
        super.log.logf(FQCN, ERROR, null, failedToCreateInstallationManager$str(), homeDir, failure);
    }
    ...
    @Override
    public final void failedToFindInstallationChannels(final Exception failure) {
        super.log.logf(FQCN, ERROR, null, failedToFindInstallationChannels$str(), failure);
    }
    ...
    @Override
    public final ZipException zipEntryOutsideOfTarget(final String entry, final String target) {
        final ZipException result = new ZipException(String.format(getLoggingLocale(), zipEntryOutsideOfTarget$str(), entry, target));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final ZipException invalidZipEntry(final String directory) {
        final ZipException result = new ZipException(String.format(getLoggingLocale(), invalidZipEntry$str(), directory));
        _copyStackTraceMinusOne(result);
        return result;
    }
}
