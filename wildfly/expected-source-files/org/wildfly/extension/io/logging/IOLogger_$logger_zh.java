...
public class IOLogger_$logger_zh extends IOLogger_$logger implements IOLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public IOLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
