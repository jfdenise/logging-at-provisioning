...
public class MicroProfileMetricsLogger_$logger_zh_CN extends MicroProfileMetricsLogger_$logger_zh implements MicroProfileMetricsLogger, BasicLogger, Serializable {
    ...
    public MicroProfileMetricsLogger_$logger_zh_CN(final org.jboss.logging.Logger logger) {
        super(logger);
    }
    ...
    protected String migrateOperationAllowedOnlyInAdminOnly$str() {
        return "WFLYMPMETRICS0010: 无法执行迁移操作。服务器必须在 admin-only 模式下。";
    }
    @Override
    protected String migrationFailed$str() {
        return "WFLYMPMETRICS0011: 迁移失败。更多详情请参阅结果。";
    }
}
