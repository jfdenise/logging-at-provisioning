...
public class CdiProviderLogger_$logger extends DelegatingBasicLogger implements CdiProviderLogger, BasicLogger, Serializable {
    ...
    @Override
    public final IllegalStateException noImplementationFound(final String className) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), noImplementationFound$str(), className));
