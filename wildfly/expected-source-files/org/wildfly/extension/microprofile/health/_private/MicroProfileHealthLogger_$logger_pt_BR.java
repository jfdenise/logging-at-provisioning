...
public class MicroProfileHealthLogger_$logger_pt_BR extends MicroProfileHealthLogger_$logger_pt implements MicroProfileHealthLogger, BasicLogger, Serializable {
    ...
    protected String defaultProceduresDisabledByDeployment$str() {
        return "WFLYMPHEALTH0007: A configuração da implantação %1$s especificou que os procedimentos padrão do MicroProfile Health devem ser desabilitados; os procedimentos em todo o servidor serão desabilitados.";
    }
}
