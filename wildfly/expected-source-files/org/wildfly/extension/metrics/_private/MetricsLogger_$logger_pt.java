...
public class MetricsLogger_$logger_pt extends MetricsLogger_$logger implements MetricsLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public MetricsLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
