...
public class UndertowLogger_$logger_zh extends UndertowLogger_$logger implements UndertowLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public UndertowLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
