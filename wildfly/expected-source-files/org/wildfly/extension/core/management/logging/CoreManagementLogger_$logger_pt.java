...
public class CoreManagementLogger_$logger_pt extends CoreManagementLogger_$logger implements CoreManagementLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public CoreManagementLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
