...
public class MessagingLogger_$logger_zh extends MessagingLogger_$logger implements MessagingLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public MessagingLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
