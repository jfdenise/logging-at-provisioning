...
public class ElytronOidcLogger_$logger_pt extends ElytronOidcLogger_$logger implements ElytronOidcLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public ElytronOidcLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
