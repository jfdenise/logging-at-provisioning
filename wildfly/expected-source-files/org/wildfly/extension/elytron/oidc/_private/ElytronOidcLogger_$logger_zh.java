...
public class ElytronOidcLogger_$logger_zh extends ElytronOidcLogger_$logger implements ElytronOidcLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public ElytronOidcLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
