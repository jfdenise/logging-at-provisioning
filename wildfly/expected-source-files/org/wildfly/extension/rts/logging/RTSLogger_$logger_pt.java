...
public class RTSLogger_$logger_pt extends RTSLogger_$logger implements RTSLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public RTSLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
