 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-07-31T11:56:53+0200")
public class SingletonLogger_$logger extends DelegatingBasicLogger implements SingletonLogger, BasicLogger, Serializable {
    ...
    @Override
    public final void singletonDeploymentDetected(final ServiceTargetFactory policy) {
        super.log.logf(FQCN, INFO, null, singletonDeploymentDetected$str(), policy);
    }
