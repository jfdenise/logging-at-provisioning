...
public class JpaHibernateSearchLogger_$logger extends DelegatingBasicLogger implements JpaHibernateSearchLogger, BasicLogger, Serializable {
    ...
    @Override
    public final IllegalStateException failOnPropertyParsingForIntegration(final String arg0, final String arg1, final Exception arg2) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), failOnPropertyParsingForIntegration$str(), arg0, arg1), arg2);
