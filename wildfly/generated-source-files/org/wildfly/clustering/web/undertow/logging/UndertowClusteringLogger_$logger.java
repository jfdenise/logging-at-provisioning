...
public class UndertowClusteringLogger_$logger extends DelegatingBasicLogger implements UndertowClusteringLogger, BasicLogger, Serializable {
    ...
    @Override
    public final IllegalStateException sessionIsInvalid(final String arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), sessionIsInvalid$str(), arg0));
    ...
    @Override
    public final void legacySessionManagementProviderOverride(final String arg0) {
        super.log.logf(FQCN, WARN, null, legacySessionManagementProviderOverride$str(), arg0);
    }
    ...
    @Override
    public final void legacySessionManagementProviderInUse(final String arg0) {
        super.log.logf(FQCN, WARN, null, legacySessionManagementProviderInUse$str(), arg0);
    }
    ...
    @Override
    public final void legacyRoutingProviderInUse(final String arg0) {
        super.log.logf(FQCN, WARN, null, legacyRoutingProviderInUse$str(), arg0);
    }
    ...
    @Override
    public final void legacySingleSignOnProviderInUse(final String arg0) {
        super.log.logf(FQCN, WARN, null, legacySingleSignOnProviderInUse$str(), arg0);
    }
