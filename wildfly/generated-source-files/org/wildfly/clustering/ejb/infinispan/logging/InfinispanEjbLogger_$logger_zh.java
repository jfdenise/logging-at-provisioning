...
public class InfinispanEjbLogger_$logger_zh extends InfinispanEjbLogger_$logger implements InfinispanEjbLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public InfinispanEjbLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
