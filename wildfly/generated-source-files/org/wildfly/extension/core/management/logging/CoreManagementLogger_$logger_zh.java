...
public class CoreManagementLogger_$logger_zh extends CoreManagementLogger_$logger implements CoreManagementLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public CoreManagementLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
