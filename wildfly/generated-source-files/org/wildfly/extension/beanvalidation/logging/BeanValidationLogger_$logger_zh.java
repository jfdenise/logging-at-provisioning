...
public class BeanValidationLogger_$logger_zh extends BeanValidationLogger_$logger implements BeanValidationLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public BeanValidationLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
