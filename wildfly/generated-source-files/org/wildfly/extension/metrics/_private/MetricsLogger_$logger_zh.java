...
public class MetricsLogger_$logger_zh extends MetricsLogger_$logger implements MetricsLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public MetricsLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
