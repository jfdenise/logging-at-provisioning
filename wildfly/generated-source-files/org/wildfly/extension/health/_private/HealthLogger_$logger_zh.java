...
public class HealthLogger_$logger_zh extends HealthLogger_$logger implements HealthLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public HealthLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
