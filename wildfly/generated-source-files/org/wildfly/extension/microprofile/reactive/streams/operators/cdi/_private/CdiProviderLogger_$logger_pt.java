...
public class CdiProviderLogger_$logger_pt extends CdiProviderLogger_$logger implements CdiProviderLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public CdiProviderLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
