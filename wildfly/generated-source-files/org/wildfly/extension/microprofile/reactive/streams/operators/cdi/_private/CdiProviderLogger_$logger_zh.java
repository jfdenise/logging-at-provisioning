...
public class CdiProviderLogger_$logger_zh extends CdiProviderLogger_$logger implements CdiProviderLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public CdiProviderLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
