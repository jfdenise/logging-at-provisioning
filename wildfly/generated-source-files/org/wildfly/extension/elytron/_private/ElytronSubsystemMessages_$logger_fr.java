...
public class ElytronSubsystemMessages_$logger_fr extends ElytronSubsystemMessages_$logger implements ElytronSubsystemMessages, BasicLogger, Serializable {
    ...
    protected String selfSignedCertificateHasBeenCreated$str() {
        return "WFLYELY01085: Certificat auto-signé généré à %1$s. Veuillez noter que les certificats auto-signés ne sont pas sécurisés et ne doivent être utilisés qu'à des fins de test. N'utilisez pas ce certificat auto-signé en production.";
    }
    @Override
