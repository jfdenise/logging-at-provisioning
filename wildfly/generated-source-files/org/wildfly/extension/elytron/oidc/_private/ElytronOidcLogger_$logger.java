 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-08-26T14:41:17+0200")
public class ElytronOidcLogger_$logger extends DelegatingBasicLogger implements ElytronOidcLogger, BasicLogger, Serializable {
    ...
    @Override
    public final void deploymentSecured(final String arg0) {
        super.log.logf(FQCN, INFO, null, deploymentSecured$str(), arg0);
    }
    ...
    @Override
    public final RuntimeException cannotRemoveCredential(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), cannotRemoveCredential$str(), arg0));
    ...
    @Override
    public final RuntimeException cannotUpdateCredential(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), cannotUpdateCredential$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException cannotRemoveRedirectRuntimeRule(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), cannotRemoveRedirectRuntimeRule$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException cannotUpdateRedirectRuntimeRule(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), cannotUpdateRedirectRuntimeRule$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final DeploymentUnitProcessingException unsupportedAttribute(final String arg0) {
        final DeploymentUnitProcessingException result = new DeploymentUnitProcessingException(String.format(getLoggingLocale(), unsupportedAttribute$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
}
