...
public class RTSLogger_$logger_zh extends RTSLogger_$logger implements RTSLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public RTSLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
