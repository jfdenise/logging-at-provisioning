...
public class RTSLogger_$logger extends DelegatingBasicLogger implements RTSLogger, BasicLogger, Serializable {
    ...
    @Override
    public final IllegalStateException failueOnImportingGlobalTransactionFromWildflyClient(final SystemException arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), failueOnImportingGlobalTransactionFromWildflyClient$str()), arg0);
    ...
    @Override
    public final void cannotGetTransactionStatus(final ContainerResponseContext arg0, final Throwable arg1) {
