...
public class MicroProfileReactiveMessagingKafkaLogger_$logger extends DelegatingBasicLogger implements MicroProfileReactiveMessagingKafkaLogger, BasicLogger, Serializable {
    ...
    @Override
    public final RuntimeException compressionNotSupportedOnWindows(final String arg0, final String arg1) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), compressionNotSupportedOnWindows$str(), arg0, arg1));
        _copyStackTraceMinusOne(result);
        return result;
    }
}
