...
public class BootableJarLogger_$logger extends DelegatingBasicLogger implements BootableJarLogger, BasicLogger, Serializable {
    ...
    @Override
    public final RuntimeException unexpectedExceptionWhileShuttingDown(final Throwable arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), unexpectedExceptionWhileShuttingDown$str()), arg0);
    ...
    @Override
    public final void installDeployment(final Path arg0) {
        super.log.logf(FQCN, INFO, null, installDeployment$str(), arg0);
    }
    protected String installDeployment$str() {
        return "WFLYJAR0006: Deployed %s in server";
    }
    @Override
    public final void advertiseInstall(final Path arg0, final long arg1) {
        super.log.logf(FQCN, INFO, null, advertiseInstall$str(), arg0, arg1);
    }
    protected String advertiseInstall$str() {
        return "WFLYJAR0007: Installed server and application in %s, took %sms";
    }
    @Override
    public final void advertiseOptions(final List<String> arg0) {
        super.log.logf(FQCN, INFO, null, advertiseOptions$str(), arg0);
    }
    protected String advertiseOptions$str() {
        return "WFLYJAR0008: Server options: %s";
    }
    @Override
    public final void deletingHome(final Path arg0) {
        super.log.logf(FQCN, DEBUG, null, deletingHome$str(), arg0);
    }
    ...
    @Override
    public final RuntimeException unknownArgument(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), unknownArgument$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException notExistingFile(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), notExistingFile$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException invalidArgument(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), invalidArgument$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException cannotStartServer(final Throwable arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), cannotStartServer$str()), arg0);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final void cantDelete(final String arg0, final IOException arg1) {
        super.log.logf(FQCN, WARN, null, cantDelete$str(), arg0, arg1);
    }
    protected String cantDelete$str() {
        return "WFLYJAR0020: Can't delete %s. Exception %s";
    }
    @Override
    public final void cantRegisterModuleMBeans(final Exception arg0) {
        super.log.logf(FQCN, WARN, null, cantRegisterModuleMBeans$str(), arg0);
    }
    ...
    @Override
    public final IllegalStateException pidFileAlreadyExists(final Path arg0, final Path arg1) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), pidFileAlreadyExists$str(), arg0, arg1));
        _copyStackTraceMinusOne(result);
        return result;
    }
    @Override
    public final void failedToStartCleanupProcess(final Throwable arg0, final Path arg1) {
        super.log.logf(FQCN, WARN, arg0, failedToStartCleanupProcess$str(), arg1);
    }
    ...
    @Override
    public final void cleanupTimeout(final long arg0, final Path arg1) {
        super.log.logf(FQCN, WARN, null, cleanupTimeout$str(), arg0, arg1);
    }
    ...
    @Override
    public final void securityProviderFailed(final Throwable arg0) {
        super.log.logf(FQCN, DEBUG, null, securityProviderFailed$str(), arg0);
    }
