...
public class IIOPLogger_$logger_pt extends IIOPLogger_$logger implements IIOPLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public IIOPLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
