...
public class InfinispanLogger_$logger extends DelegatingBasicLogger implements InfinispanLogger, BasicLogger, Serializable {
    ...
    @Override
    public final void cacheStarted(final String arg0, final String arg1) {
        super.log.logf(FQCN, INFO, null, cacheStarted$str(), arg0, arg1);
    }
    protected String cacheStarted$str() {
        return "WFLYCLINF0002: Started %s cache from %s container";
    }
    @Override
    public final void cacheStopped(final String arg0, final String arg1) {
        super.log.logf(FQCN, INFO, null, cacheStopped$str(), arg0, arg1);
    }
    ...
    @Override
    public final IllegalArgumentException invalidCacheStore(final Throwable arg0, final String arg1) {
        final IllegalArgumentException result = new IllegalArgumentException(String.format(getLoggingLocale(), invalidCacheStore$str(), arg1), arg0);
    ...
    @Override
    public final void remoteCacheContainerStarted(final String arg0) {
        super.log.logf(FQCN, INFO, null, remoteCacheContainerStarted$str(), arg0);
    }
    protected String remoteCacheContainerStarted$str() {
        return "WFLYCLINF0029: Started remote cache container '%s'.";
    }
    @Override
    public final void remoteCacheContainerStopped(final String arg0) {
        super.log.logf(FQCN, INFO, null, remoteCacheContainerStopped$str(), arg0);
    }
    protected String remoteCacheContainerStopped$str() {
        return "WFLYCLINF0030: Stopped remote cache container '%s'.";
    }
    @Override
    public final void marshallerEnumValueDeprecated(final String arg0, final Object arg1, final Set<?> arg2) {
        super.log.logf(FQCN, WARN, null, marshallerEnumValueDeprecated$str(), arg0, arg1, arg2);
    }
