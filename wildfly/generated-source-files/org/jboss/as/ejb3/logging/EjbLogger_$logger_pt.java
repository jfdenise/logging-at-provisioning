...
public class EjbLogger_$logger_pt extends EjbLogger_$logger implements EjbLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public EjbLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
