...
public class EjbLogger_$logger_pt_BR extends EjbLogger_$logger_pt implements EjbLogger, BasicLogger, Serializable {
    ...
    protected String invalidComponentState$str() {
        return "WFLYEJB0370: O componente Jakarta Enterprise Beans para o endereço %1$s está em estado %n, deve estar em estado %3$s";
    }
    @Override
    ...
    protected String moreThanOneEjbFound4$str() {
        return "WFLYEJB0407: Mais de um Jakarta Enterprise Beans encontrado com interface do tipo '%1$s' e nome '%2$s' para a associação. Encontrado: %4$s";
    }
    @Override
