...
public class EjbLogger_$logger_zh extends EjbLogger_$logger implements EjbLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public EjbLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
