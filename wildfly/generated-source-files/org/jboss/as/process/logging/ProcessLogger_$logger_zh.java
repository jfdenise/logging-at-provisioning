...
public class ProcessLogger_$logger_zh extends ProcessLogger_$logger implements ProcessLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public ProcessLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
