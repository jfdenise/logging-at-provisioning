...
public class JpaLogger_$logger_zh extends JpaLogger_$logger implements JpaLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public JpaLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
