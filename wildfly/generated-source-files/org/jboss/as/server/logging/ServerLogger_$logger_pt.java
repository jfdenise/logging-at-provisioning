...
public class ServerLogger_$logger_pt extends ServerLogger_$logger implements ServerLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public ServerLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
