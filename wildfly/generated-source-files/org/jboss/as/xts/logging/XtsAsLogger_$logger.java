 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-08-26T14:41:56+0200")
public class XtsAsLogger_$logger extends DelegatingBasicLogger implements XtsAsLogger, BasicLogger, Serializable {
    ...
    @Override
    public final void cannotGetTransactionStatus(final MessageContext arg0, final Throwable arg1) {
        super.log.logf(FQCN, ERROR, arg1, cannotGetTransactionStatus$str(), arg0);
    }
    ...
    @Override
    public final XTSException unexpectedBridgeType(final String arg0) {
        final XTSException result = new XTSException(String.format(getLoggingLocale(), unexpectedBridgeType$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final DeploymentUnitProcessingException errorProcessingEndpoint(final String arg0, final Throwable arg1) {
        final DeploymentUnitProcessingException result = new DeploymentUnitProcessingException(String.format(getLoggingLocale(), errorProcessingEndpoint$str(), arg0), arg1);
        _copyStackTraceMinusOne(result);
        return result;
    }
}
