...
public class XtsAsLogger_$logger_zh extends XtsAsLogger_$logger implements XtsAsLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public XtsAsLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
