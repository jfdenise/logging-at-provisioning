...
public class SarLogger_$logger_zh extends SarLogger_$logger implements SarLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public SarLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
