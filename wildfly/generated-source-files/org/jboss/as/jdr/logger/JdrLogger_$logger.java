...
public class JdrLogger_$logger extends DelegatingBasicLogger implements JdrLogger, BasicLogger, Serializable {
    ...
    @Override
    public final void couldNotCreateJDRPropertiesFile(final IOException arg0, final Path arg1) {
        super.log.logf(FQCN, ERROR, arg0, couldNotCreateJDRPropertiesFile$str(), arg1);
    }
