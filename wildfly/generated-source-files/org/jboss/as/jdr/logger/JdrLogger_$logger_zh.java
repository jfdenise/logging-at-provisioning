...
public class JdrLogger_$logger_zh extends JdrLogger_$logger implements JdrLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public JdrLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
