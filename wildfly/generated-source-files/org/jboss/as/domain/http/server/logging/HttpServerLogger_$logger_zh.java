...
public class HttpServerLogger_$logger_zh extends HttpServerLogger_$logger implements HttpServerLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public HttpServerLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
