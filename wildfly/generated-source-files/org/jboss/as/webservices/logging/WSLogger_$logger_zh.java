...
public class WSLogger_$logger_zh extends WSLogger_$logger implements WSLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public WSLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
