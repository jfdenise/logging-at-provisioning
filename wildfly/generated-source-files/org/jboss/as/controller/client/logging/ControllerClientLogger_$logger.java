 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-08-26T14:41:10+0200")
public class ControllerClientLogger_$logger extends DelegatingBasicLogger implements ControllerClientLogger, BasicLogger, Serializable {
    ...
    @Override
    public final String cannotConvert(final String arg0, final String arg1) {
        return String.format(getLoggingLocale(), cannotConvert$str(), arg0, arg1);
    }
    ...
    @Override
    public final IllegalArgumentException cannotDeriveDeploymentName(final URL arg0) {
        final IllegalArgumentException result = new IllegalArgumentException(String.format(getLoggingLocale(), cannotDeriveDeploymentName$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final String domainDeploymentAlreadyExists(final String arg0) {
        return String.format(getLoggingLocale(), domainDeploymentAlreadyExists$str(), arg0);
    }
    ...
    @Override
    public final IllegalStateException gracefulShutdownAlreadyConfigured(final long arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), gracefulShutdownAlreadyConfigured$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final String incompleteDeploymentReplace(final String arg0, final String arg1) {
        return String.format(getLoggingLocale(), incompleteDeploymentReplace$str(), arg0, arg1);
    }
    protected String invalidActionType$str() {
        return "WFLYCC0012: Invalid action type %s";
    }
    @Override
    public final IllegalStateException invalidActionType(final Type arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), invalidActionType$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalStateException invalidPrecedingAction(final Object arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), invalidPrecedingAction$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalArgumentException invalidUri(final Throwable arg0, final URL arg1) {
        final IllegalArgumentException result = new IllegalArgumentException(String.format(getLoggingLocale(), invalidUri$str(), arg1), arg0);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalArgumentException invalidValue(final String arg0, final int arg1, final int arg2) {
        final IllegalArgumentException result = new IllegalArgumentException(String.format(getLoggingLocale(), invalidValue3$str(), arg0, arg1, arg2));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalArgumentException invalidValue(final String arg0, final int arg1, final int arg2, final int arg3) {
        final IllegalArgumentException result = new IllegalArgumentException(String.format(getLoggingLocale(), invalidValue4$str(), arg0, arg1, arg2, arg3));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalStateException notConfigured(final String arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), notConfigured$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalStateException objectIsClosed(final String arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), objectIsClosed$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final RuntimeException operationOutcome(final String arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), operationOutcome$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final IllegalStateException operationsNotAllowed(final String arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), operationsNotAllowed$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final String serverDeploymentAlreadyExists(final String arg0) {
        return String.format(getLoggingLocale(), serverDeploymentAlreadyExists$str(), arg0);
    }
    protected String unknownActionType$str() {
        return "WFLYCC0029: Unknown action type %s";
    }
    @Override
    public final IllegalStateException unknownActionType(final Object arg0) {
        final IllegalStateException result = new IllegalStateException(String.format(getLoggingLocale(), unknownActionType$str(), arg0));
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final void leakedControllerClient(final Throwable arg0) {
        super.log.logf(FQCN, WARN, arg0, leakedControllerClient$str());
    }
    ...
    @Override
    public final RuntimeException failedToParseAuthenticationConfig(final Throwable arg0, final URI arg1) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), failedToParseAuthenticationConfig$str(), arg1), arg0);
        _copyStackTraceMinusOne(result);
        return result;
    }
}
