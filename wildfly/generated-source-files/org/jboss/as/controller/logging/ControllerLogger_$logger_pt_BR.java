...
public class ControllerLogger_$logger_pt_BR extends ControllerLogger_$logger_pt implements ControllerLogger, BasicLogger, Serializable {
    ...
    protected String deadLock$str() {
        return "WFLYCTL0497: Deadlock detectado!";
    }
    @Override
    ...
    protected String threadDump$str() {
        return "WFLYCTL0496: Descarte de thread:";
    }
    @Override
    ...
    protected String moreThanOneInstanceOfAdditionalBootCliScriptInvokerFound$str() {
        return "WFLYCTL0463: Mais de uma instância de AdditionalBootCliScriptInvoker encontrada. Há: \"'; encontrada: '%2$s'";
    }
    @Override
