...
public class SecurityLogger_$logger extends DelegatingBasicLogger implements SecurityLogger, BasicLogger, Serializable {
    ...
    @Override
    public final RuntimeException runtimeException(final Throwable arg0) {
        final RuntimeException result = new RuntimeException(String.format(getLoggingLocale(), runtimeException$str()), arg0);
    ...
    @Override
    public final SecurityException securityException(final Throwable arg0) {
        final SecurityException result = new SecurityException(String.format(getLoggingLocale(), securityException$str()), arg0);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final XMLStreamException xmlStreamExceptionAuth(final Location arg0) {
        final XMLStreamException result = new XMLStreamException(String.format(getLoggingLocale(), xmlStreamExceptionAuth$str()), arg0);
        _copyStackTraceMinusOne(result);
        return result;
    }
    ...
    @Override
    public final XMLStreamException xmlStreamExceptionMissingAttribute(final String arg0, final String arg1, final Location arg2) {
        final XMLStreamException result = new XMLStreamException(String.format(getLoggingLocale(), xmlStreamExceptionMissingAttribute$str(), arg0, arg1), arg2);
        _copyStackTraceMinusOne(result);
        return result;
    }
