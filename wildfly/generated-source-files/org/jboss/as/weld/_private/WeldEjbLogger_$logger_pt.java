...
public class WeldEjbLogger_$logger_pt extends WeldEjbLogger_$logger implements WeldEjbLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public WeldEjbLogger_$logger_pt(final org.jboss.logging.Logger logger) {
        super(logger);
    }
