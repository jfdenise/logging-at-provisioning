 ...
 */
@Generated(value = "org.jboss.logging.processor.generator.model.MessageLoggerImplementor", date = "2026-08-26T14:41:26+0200")
public class JSFLogger_$logger extends DelegatingBasicLogger implements JSFLogger, BasicLogger, Serializable {
    ...
    @Override
    public final void managedBeansConfigParseFailed(final VirtualFile arg0) {
        super.log.logf(FQCN, ERROR, null, managedBeansConfigParseFailed$str(), arg0);
    }
    ...
    @Override
    public final void unknownJSFVersion(final String arg0, final String arg1) {
        super.log.logf(FQCN, WARN, null, unknownJSFVersion$str(), arg0, arg1);
    }
    ...
    @Override
    public final void missingJSFModule(final String arg0, final String arg1) {
        super.log.logf(FQCN, WARN, null, missingJSFModule$str(), arg0, arg1);
    }
    protected String missingJSFModule$str() {
        return "WFLYJSF0006: Jakarta Server Faces version slot '%s' is missing from module %s";
    }
    @Override
    public final void activatedJSFImplementations(final List arg0) {
        super.log.logf(FQCN, INFO, null, activatedJSFImplementations$str(), arg0);
    }
    ...
    @Override
    public final String classLoadingFailed(final DotName arg0) {
        return String.format(getLoggingLocale(), classLoadingFailed$str(), arg0);
    }
    protected String invalidAnnotationLocation$str() {
        return "WFLYJSF0009: Annotation %s in class %s is only allowed on classes";
    }
    @Override
    public final String invalidAnnotationLocation(final Object arg0, final AnnotationTarget arg1) {
        return String.format(getLoggingLocale(), invalidAnnotationLocation$str(), arg0, arg1);
    }
    ...
    @Override
    public final DeploymentUnitProcessingException invalidDefaultJSFImpl(final String arg0) {
        final DeploymentUnitProcessingException result = new DeploymentUnitProcessingException(String.format(getLoggingLocale(), invalidDefaultJSFImpl$str(), arg0));
    ...
    @Override
    public final DeploymentUnitProcessingException jsfInjectionFailed(final String arg0, final Throwable arg1) {
        final DeploymentUnitProcessingException result = new DeploymentUnitProcessingException(String.format(getLoggingLocale(), jsfInjectionFailed$str(), arg0), arg1);
        _copyStackTraceMinusOne(result);
        return result;
    }
    @Override
    ...
    @Override
    public final void jsfArtifactNoDefaultConstructor(final String arg0, final String arg1) {
        super.log.logf(FQCN, INFO, null, jsfArtifactNoDefaultConstructor$str(), arg0, arg1);
    }
