...
public class JSFLogger_$logger_zh extends JSFLogger_$logger implements JSFLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public JSFLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
