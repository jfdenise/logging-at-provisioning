...
public class PatchLogger_$logger_zh extends PatchLogger_$logger implements PatchLogger, BasicLogger, Serializable {
    private static final long serialVersionUID = 1L;
    public PatchLogger_$logger_zh(final org.jboss.logging.Logger logger) {
        super(logger);
    }
